...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MyUser.facebook_id'
        db.add_column('cn_my_user', 'facebook_id',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MyUser.facebook_id'
        db.delete_column('cn_my_user', 'facebook_id')
    ...
    models = {
        ...
        u'hackusername.myuser': {
            ...
            'facebook_id': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
